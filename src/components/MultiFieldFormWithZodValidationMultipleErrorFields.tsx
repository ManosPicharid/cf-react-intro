...
const MultiFieldFormWithZodValidationMultipleErrorFields = () => {
      ...
      <form onSubmit={handleSubmit} className="space-y-4 w-full">
        <div>
          ...
          {errors.name?.map((msg, idx) => (
            <p key={idx} className="text-cf-dark-red text-sm">
              {msg}
            </p>
          ))}
        </div>
...
export default MultiFieldFormWithZodValidationMultipleErrorFields;
